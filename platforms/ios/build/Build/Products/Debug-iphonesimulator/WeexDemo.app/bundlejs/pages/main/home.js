...
exports.default = {
    ...
    methods: {
        ...
        jumpWeb: function jumpWeb(_url) {
            ...
            modal.toast({ message: _util2.default.setBundleUrl(url, 'pages/webview/index.js'), duration: 50 });
            console.log('当前文件所在绝对路径：', url);
            console.log('计算出需要跳转的文件所在绝对路径：', _util2.default.setBundleUrl(url, 'pages/webview/index.js'));
        },
