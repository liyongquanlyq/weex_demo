<template>
    <refresh class="u-refresh" @refresh="onrefresh" @pullingdown="onpullingdown" :display="refreshing ? 'show' : 'hide'">
        <image class="loading-bg" resize="contain" src="http://imgv1.okoooimg.com/image/header/okooologo218x40.png?v=20170111"></image>
        <div class="l-txt-box">
            <text ref="lTxt1" class="l-txt l-txt-1">用</text>
            <text ref="lTxt2" class="l-txt l-txt-2">户</text>
            <text ref="lTxt3" class="l-txt l-txt-3">第</text>
            <text ref="lTxt4" class="l-txt l-txt-4">一</text>
            <text ref="lTxt5" class="l-txt l-txt-5">数</text>
            <text ref="lTxt6" class="l-txt l-txt-6">据</text>
            <text ref="lTxt7" class="l-txt l-txt-7">为</text>
            <text ref="lTxt8" class="l-txt l-txt-8">王</text>
        </div>
    </refresh>
</template>
<style scoped>
